...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 14, 2022 at 04:10 PM
...
(6, ' ', '', '', '$2y$10$2FBLFNPPm3oGNFT6OdV6QOXqTjrwscymvaYEtJfa70L/o5Cwc09aW', NULL, NULL, NULL, NULL, NULL);
...
(1, 'Kamau', 'Njoroge', 'kamau@gmail.com', '0732456789', '//Get requests for visit in vet\'s portal\nfunction getVetRequests(){\n    $conn = connect();\n    $sql ', 'Tom Mboya Street, Nairobi CBD', 'Nairobi', 'Kenya', 2, -1.28363, 36.8251),
...
--
ALTER TABLE `tbl_farmers`
  MODIFY `farmer_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
